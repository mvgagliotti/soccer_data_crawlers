...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.referee_ass1'
        db.add_column(u'matches_match', 'referee_ass1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ref_aux1', null=True, to=orm['matches.Referee']),
                      keep_default=False)

        # Adding field 'Match.referee_ass2'
        db.add_column(u'matches_match', 'referee_ass2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ref_aux2', null=True, to=orm['matches.Referee']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.referee_ass1'
        db.delete_column(u'matches_match', 'referee_ass1_id')

        # Deleting field 'Match.referee_ass2'
        db.delete_column(u'matches_match', 'referee_ass2_id')
