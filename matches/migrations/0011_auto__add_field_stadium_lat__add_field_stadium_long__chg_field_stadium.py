...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stadium.lat'
        db.add_column(u'matches_stadium', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'Stadium.long'
        db.add_column(u'matches_stadium', 'long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=8, blank=True),
                      keep_default=False)


        # Changing field 'Stadium.city'
        db.alter_column(u'matches_stadium', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.City'], null=True))

        # Changing field 'Stadium.full_name'
        db.alter_column(u'matches_stadium', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Stadium.lat'
        db.delete_column(u'matches_stadium', 'lat')

        # Deleting field 'Stadium.long'
        db.delete_column(u'matches_stadium', 'long')


        # Changing field 'Stadium.city'
        db.alter_column(u'matches_stadium', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cities.City']))

        # Changing field 'Stadium.full_name'
        db.alter_column(u'matches_stadium', 'full_name', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'public_thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'public_thread'", 'to': u"orm['comments.Thread']"}),
        ...
        u'matches.stadium': {
            ...
            'long': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8', 'blank': 'True'}),
