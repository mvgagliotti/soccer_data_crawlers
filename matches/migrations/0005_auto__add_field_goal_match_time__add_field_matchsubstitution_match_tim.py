...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.match_time'
        db.add_column(u'matches_goal', 'match_time',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchSubstitution.match_time'
        db.add_column(u'matches_matchsubstitution', 'match_time',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.match_time'
        db.delete_column(u'matches_goal', 'match_time')

        # Deleting field 'MatchSubstitution.match_time'
        db.delete_column(u'matches_matchsubstitution', 'match_time')
