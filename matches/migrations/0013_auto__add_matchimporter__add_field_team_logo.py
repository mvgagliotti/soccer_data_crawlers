...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchImporter'
        db.create_table(u'matches_matchimporter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('matchs_to_import', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('imported_matches', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('imported', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'matches', ['MatchImporter'])

        # Adding field 'Team.logo'
        db.add_column(u'matches_team', 'logo',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MatchImporter'
        db.delete_table(u'matches_matchimporter')

        # Deleting field 'Team.logo'
        db.delete_column(u'matches_team', 'logo')
