...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.public_thread'
        db.alter_column(u'matches_match', 'public_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['comments.Thread']))

        # Changing field 'ChampionshipPhase.name'
        db.alter_column(u'matches_championshipphase', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Match.public_thread'
        raise RuntimeError("Cannot reverse this migration. 'Match.public_thread' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Match.public_thread'
        db.alter_column(u'matches_match', 'public_thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Thread']))

        # Changing field 'ChampionshipPhase.name'
        db.alter_column(u'matches_championshipphase', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        u'cities.country': {
            ...
            'numcode': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        },
        u'cities.region': {
        ...
        u'comments.thread': {
            ...
            'locked_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'started_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        ...
        u'matches.match': {
            ...
            'public_thread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'public_thread'", 'null': 'True', 'to': u"orm['comments.Thread']"}),
            ...
            'user_thread': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_thread'", 'symmetrical': 'False', 'through': u"orm['matches.UserThread']", 'to': u"orm['comments.Thread']"})
        },
        u'matches.matchimporter': {
            'Meta': {'object_name': 'MatchImporter'},
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imported': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'imported_matches': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'matchs_to_import': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'matches.stadium': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8', 'blank': 'True'}),
            'lng': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8', 'blank': 'True'}),
        ...
        u'matches.userthread': {
            'Meta': {'object_name': 'UserThread'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['matches.Match']"}),
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comments.Thread']"}),
