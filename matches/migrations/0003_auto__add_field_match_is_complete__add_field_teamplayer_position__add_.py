...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.is_complete'
        db.add_column(u'matches_match', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TeamPlayer.position'
        db.add_column(u'matches_teamplayer', 'position',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchPlayer.first_yellow_card_time'
        db.add_column(u'matches_matchplayer', 'first_yellow_card_time',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchPlayer.second_card_or_red_card_time'
        db.add_column(u'matches_matchplayer', 'second_card_or_red_card_time',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MatchPlayer.position'
        db.add_column(u'matches_matchplayer', 'position',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Referee.date_of_birth'
        db.add_column(u'matches_referee', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Referee.birth_data'
        db.add_column(u'matches_referee', 'birth_data',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.is_complete'
        db.delete_column(u'matches_match', 'is_complete')

        # Deleting field 'TeamPlayer.position'
        db.delete_column(u'matches_teamplayer', 'position')

        # Deleting field 'MatchPlayer.first_yellow_card_time'
        db.delete_column(u'matches_matchplayer', 'first_yellow_card_time')

        # Deleting field 'MatchPlayer.second_card_or_red_card_time'
        db.delete_column(u'matches_matchplayer', 'second_card_or_red_card_time')

        # Deleting field 'MatchPlayer.position'
        db.delete_column(u'matches_matchplayer', 'position')

        # Deleting field 'Referee.date_of_birth'
        db.delete_column(u'matches_referee', 'date_of_birth')

        # Deleting field 'Referee.birth_data'
        db.delete_column(u'matches_referee', 'birth_data')
