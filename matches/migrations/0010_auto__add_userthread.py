...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserThread'
        db.create_table(u'matches_userthread', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.Match'])),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Thread'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'matches', ['UserThread'])

        # Removing M2M table for field user_thread on 'Match'
        db.delete_table(db.shorten_name(u'matches_match_user_thread'))


    def backwards(self, orm):
        # Deleting model 'UserThread'
        db.delete_table(u'matches_userthread')

        # Adding M2M table for field user_thread on 'Match'
        m2m_table_name = db.shorten_name(u'matches_match_user_thread')
        ...
        db.create_unique(m2m_table_name, ['match_id', 'thread_id'])
