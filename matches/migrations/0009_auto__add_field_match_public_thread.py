...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.public_thread'
        db.add_column(u'matches_match', 'public_thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='public_thread', to=orm['comments.Thread']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Match.public_thread'
        db.delete_column(u'matches_match', 'public_thread_id')
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'user_thread': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'user_thread'", 'symmetrical': 'False', 'to': u"orm['comments.Thread']"})
        },
