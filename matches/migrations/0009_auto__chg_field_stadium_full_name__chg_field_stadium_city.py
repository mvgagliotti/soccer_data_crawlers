...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Stadium.full_name'
        raise RuntimeError("Cannot reverse this migration. 'Stadium.full_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Stadium.full_name'
        db.alter_column(u'matches_stadium', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'Stadium.city'
        raise RuntimeError("Cannot reverse this migration. 'Stadium.city' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Stadium.city'
        db.alter_column(u'matches_stadium', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.City']))
