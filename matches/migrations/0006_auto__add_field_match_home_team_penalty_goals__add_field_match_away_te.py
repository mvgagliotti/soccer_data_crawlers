...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.home_team_penalty_goals'
        db.add_column(u'matches_match', 'home_team_penalty_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Match.away_team_penalty_goals'
        db.add_column(u'matches_match', 'away_team_penalty_goals',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.home_team_penalty_goals'
        db.delete_column(u'matches_match', 'home_team_penalty_goals')

        # Deleting field 'Match.away_team_penalty_goals'
        db.delete_column(u'matches_match', 'away_team_penalty_goals')
